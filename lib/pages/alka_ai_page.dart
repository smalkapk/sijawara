...
class AlkaAiPage extends StatefulWidget {
  final String? initialContextMessage;

  const AlkaAiPage({super.key, this.initialContextMessage});

  @override
  State<AlkaAiPage> createState() => _AlkaAiPageState();
}

class _AlkaAiPageState extends State<AlkaAiPage> {
