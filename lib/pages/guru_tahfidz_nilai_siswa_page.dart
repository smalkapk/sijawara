...
import 'guru_tahfidz_nilai_report_page.dart';

class GuruTahfidzNilaiSiswaPage extends StatefulWidget {
  final int classId;
  final String className;
  const GuruTahfidzNilaiSiswaPage({
    super.key,
  ...
  @override
  State<GuruTahfidzNilaiSiswaPage> createState() =>
      _GuruTahfidzNilaiSiswaPageState();
}

class _GuruTahfidzNilaiSiswaPageState extends State<GuruTahfidzNilaiSiswaPage> {
  ...
  Future<void> _loadStudents() async {
    ...
    try {
      final students = await TahfidzService.getStudentsByClass(
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => GuruTahfidzNilaiReportPage(
