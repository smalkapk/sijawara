...
import 'wali_diskusi_guru_page.dart';
import 'wali_tugas_siswa_page.dart';
import 'wali_maklumat_page.dart';
import 'wali_aduan_aplikasi_page.dart';
...
final Map<String, _NavAction> _navActions = {
  'diskusi_guru': _NavAction(
    label: 'Buka Halaman Diskusi Guru',
    icon: Icons.mail_rounded,
    pageBuilder: () => const WaliDiskusiGuruPage(),
  ),
  'tugas_siswa': _NavAction(
    label: 'Buka Halaman Tugas Siswa',
    icon: Icons.forum_rounded,
    pageBuilder: () => const WaliTugasSiswaPage(),
  ),
  'maklumat': _NavAction(
    label: 'Buka Halaman Maklumat',
    icon: Icons.notifications_active_rounded,
    pageBuilder: () => const WaliMaklumatPage(),
  ),
  'aduan_aplikasi': _NavAction(
    label: 'Buka Halaman Aduan Aplikasi',
    icon: Icons.bug_report_rounded,
    pageBuilder: () => const WaliAduanAplikasiPage(),
  ),
  'bantuan': _NavAction(
    label: 'Buka Halaman Bantuan',
    icon: Icons.help_outline_rounded,
    pageBuilder: () => const WaliBantuanPage(),
  ),
  'profil': _NavAction(
    label: 'Buka Halaman Profil',
    icon: Icons.person_rounded,
    pageBuilder: () => const WaliProfilePage(),
  ),
  'live': _NavAction(
    label: 'Buka Halaman Live Data',
    icon: Icons.sensors_rounded,
    pageBuilder: () => const WaliLivePage(),
  ),
};
...
class WaliAlkaAiPage extends StatefulWidget {
  final String? initialContextMessage;

  const WaliAlkaAiPage({super.key, this.initialContextMessage});

  @override
  State<WaliAlkaAiPage> createState() => _WaliAlkaAiPageState();
}

class _WaliAlkaAiPageState extends State<WaliAlkaAiPage> {
  ...
  static const String _welcomeMsg =
      'Halo! Saya ALKA AI, asisten virtual Sijawara. Ada yang bisa saya bantu hari ini? 😊\n\nSaya bisa membantu Anda tentang fitur-fitur aplikasi seperti **Diskusi Guru**, **Tugas Siswa**, **Maklumat**, dan lainnya.';
