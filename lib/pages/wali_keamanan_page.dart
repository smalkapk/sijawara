...
class WaliKeamananPage extends StatefulWidget {
  const WaliKeamananPage({super.key});

  @override
  State<WaliKeamananPage> createState() => _WaliKeamananPageState();
}

class _WaliKeamananPageState extends State<WaliKeamananPage> {
      ...
      SnackBar(
        content: const Row(
          children: [
            ...
            Expanded(
              child: Text(
                'Fitur ganti kata sandi orang tua/wali akan segera hadir',
